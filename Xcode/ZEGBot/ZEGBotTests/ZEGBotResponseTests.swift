...
class ZEGBotResponseTests: XCTestCase {
	...
	func testEditMessageText() {
	
		let chat = Chat(id: 80548625, type: "", title: nil, username: nil, first_name: nil, last_name: nil)
		let message = Message(message_id: 52593, date: 0, chat: chat, from: nil, forward_from: nil, forward_from_chat: nil, forward_date: nil, reply_to_message: nil, edit_date: nil, text: nil, entities: nil, audio: nil, document: nil, photo: nil, sticker: nil, video: nil, voice: nil, caption: nil, contact: nil, location: nil, venue: nil, new_chat_member: nil, left_chat_member: nil, new_chat_title: nil, new_chat_photo: nil, delete_chat_photo: nil, group_chat_created: nil, supergroup_chat_created: nil, channel_chat_created: nil, migrate_to_chat_id: nil, migrate_from_chat_id: nil, pinned_message: nil)
		
		ZEGResponse.editMessageText(message, to: "*hhhhh*[testSendMessage](https://google.com)", parse_mode: .Markdown, disable_web_page_preview: true, disable_notification: true, reply_markup: inlineKeyboardMarkup)
